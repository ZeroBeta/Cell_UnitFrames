...
Defaults.Layouts = {
    player = {
        ...
        visibility = "", -- WotLK: petbattle doesn't exist, use empty string
        healthBarTexture = "Interface\\AddOns\\Cell_Wrath\\Media\\statusbar.tga",
        useHealthBarTexture = false,
        healthLossTexture = "Interface\\AddOns\\Cell_Wrath\\Media\\statusbar.tga",
        useHealthLossTexture = false,
        powerBarTexture = "Interface\\AddOns\\Cell_Wrath\\Media\\statusbar.tga",
        usePowerBarTexture = false,
        powerLossTexture = "Interface\\AddOns\\Cell_Wrath\\Media\\statusbar.tga",
