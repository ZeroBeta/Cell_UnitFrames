...
local function IsFrameFocused(frame)
    -- WotLK: Use GetMouseFocus() instead of GetMouseFoci() (which is Retail-only)
    local focusedFrame = GetMouseFocus and GetMouseFocus()
    return focusedFrame and focusedFrame == frame
end
